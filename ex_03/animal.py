class Animal:
    ...
    @classmethod #création de la méthode permettant de savoir le nombre d'objet de la class animal
    ...
    @classmethod #créaton de la methode permettant de connaitre le nombre d'objet de type "mammals" de la class animal
    ...
    @classmethod #créaton de la methode permettant de connaitre le nombre d'objet de type "fish" de la class animal
    ...
    @classmethod #créaton de la methode permettant de connaitre le nombre d'objet de type "bird" de la class animal
